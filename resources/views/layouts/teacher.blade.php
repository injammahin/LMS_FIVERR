...
<body class="bg-gray-50 text-gray-900">
    ...
    <div class="min-h-screen">
        ...
        <div id="sidebarBackdrop"
             class="fixed inset-0 z-40 bg-gray-900/40 hidden md:hidden"
             aria-hidden="true"></div>

        {{-- Sidebar (fixed, not scrollable) --}}
        <aside id="sidebar"
               class="fixed inset-y-0 left-0 z-50 w-72 bg-white border-r border-gray-200
            ...
            <div class="h-16 px-5 border-b border-gray-200 flex items-center justify-between">
                <div class="flex items-center gap-3">
                    <div class="w-9 h-9 rounded-xl bg-gradient-to-br from-blue-600 to-indigo-600 grid place-items-center text-white shadow-sm">
            ...
            <nav class="p-4 space-y-2">
                <a href="{{ route('teacher.dashboard') }}"
                   class="group flex items-center justify-between px-4 py-3 rounded-xl hover:bg-gray-50 transition">
                    <span class="flex items-center gap-3 text-sm font-medium text-gray-900">
                        <span class="w-9 h-9 rounded-xl bg-gray-50 border border-gray-200 grid place-items-center text-gray-700 group-hover:text-blue-700">
                ...
                <a href="{{ route('teacher.submissions.index') }}"
                   class="group flex items-center justify-between px-4 py-3 rounded-xl hover:bg-gray-50 transition">
                    <span class="flex items-center gap-3 text-sm font-medium text-gray-900">
                        <span class="w-9 h-9 rounded-xl bg-amber-50 border border-amber-200 grid place-items-center text-amber-700">
                ...
                <a href="{{ route('teacher.notifications.index') }}"
                   class="group flex items-center justify-between px-4 py-3 rounded-xl hover:bg-gray-50 transition">
                    <span class="flex items-center gap-3 text-sm font-medium text-gray-900">
                        <span class="w-9 h-9 rounded-xl bg-blue-50 border border-blue-200 grid place-items-center text-blue-700">
            ...
            <div class="absolute bottom-0 left-0 right-0 p-4 border-t border-gray-200 bg-white">
                <div class="rounded-2xl bg-gradient-to-r from-gray-50 to-white border border-gray-200 p-4">
                    <div class="flex items-start gap-3">
                        <div class="w-9 h-9 rounded-xl bg-white border border-gray-200 grid place-items-center text-gray-700">
        ...
        <div class="md:pl-72">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <a href="{{ route('teacher.notifications.index') }}"
                           ...
                           aria-label="Notifications">
                            ...
                            @if($unread > 0)
                                <span class="absolute -top-1 -right-1 min-w-[18px] h-[18px] px-1 rounded-full bg-red-600 text-white text-[10px] grid place-items-center">
                                    {{ $unread }}
                                </span>
                            @endif
                        </a>
                        ...
                        <div class="relative" id="profileDropdown">
                            <button id="profileBtn"
                                ...
                                <span class="w-7 h-7 rounded-lg bg-gradient-to-br from-blue-600 to-indigo-600 text-white grid place-items-center text-xs font-bold">
                            ...
                            <div id="profileMenu"
                                ...
                                <div class="p-4 border-b border-gray-100">
                                    ...
                                    <div class="mt-2 inline-flex items-center gap-2 text-[11px] px-2 py-1 rounded-full bg-emerald-50 border border-emerald-200 text-emerald-700">
                                ...
                                <div class="p-2">
                                    ...
                                    <a href="{{ route('teacher.notifications.index') }}"
                                       class="flex items-center justify-between px-3 py-2 rounded-xl hover:bg-gray-50 transition text-sm">
                                        ...
                                        <span class="text-[11px] px-2 py-0.5 rounded-full bg-blue-50 border border-blue-200 text-blue-700">
                                            {{ $c['unread'] }}
                                        </span>
                                    </a>
                                </div>
            ...
            <main class="p-4 sm:p-6">
                @if(session('success'))
                    <div class="mb-4 rounded-2xl border border-green-200 bg-green-50 p-4 text-green-800 flex items-start gap-3">
