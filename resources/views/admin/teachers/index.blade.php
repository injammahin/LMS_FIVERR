                            ...
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="px-6 py-4 text-right space-x-2">
                                    ...
                                    <button type="button" @click="
                                                openToggle = true;
                                                toggleUrl = '{{ route('admin.teachers.toggle-status', $teacher->id) }}';
                                                toggleAction = '{{ $teacher->is_active ? 'Suspend' : 'Activate' }}';
                                                toggleName = '{{ addslashes($teacher->name) }}';
                                            "
                                        class="inline-flex items-center justify-center px-3 py-1.5 rounded-lg border border-gray-200 text-[10px]
                                                   {{ $teacher->is_active ? 'bg-yellow-100 text-yellow-700 hover:bg-yellow-200' : 'bg-green-100 text-green-700 hover:bg-green-200' }}">
            ...
            <div @click.away="openToggle = false" class="bg-white rounded-xl shadow-lg w-96 p-6">
                ...
                <div class="flex items-center gap-3 mb-4">
                    ...
                    <h3 class="font-semibold text-gray-800 text-sm">
                        <span x-text="toggleAction"></span> Teacher
                    </h3>
                </div>
