...
<div class="space-y-8">
    ...
    {{-- PAGE HEADER --}}
    <div>
        <h1 class="text-xl font-bold text-slate-800 dark:text-white">LMS Dashboard</h1>
            ...
            <table class="min-w-full text-sm">
                ...
                <tbody class="text-slate-700 dark:text-slate-300">
                    ...
                    <tr class="border-b border-slate-100 dark:border-slate-800">
                        ...
                        <td>Feb 22, 2026</td>
                        <td><span class="px-3 py-1 text-xs bg-green-100 text-green-700 rounded-full">Completed</span></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>Feb 20, 2026</td>
                        <td><span class="px-3 py-1 text-xs bg-purple-100 text-purple-700 rounded-full">Reviewed</span></td>
                    </tr>
