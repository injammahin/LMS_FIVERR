...
<div class="max-w-3xl mx-auto space-y-6" x-data="{ showPreview: false }">
    ...
    <div class="flex items-start justify-between gap-4">
        <div class="space-y-2">
            <h1 class="text-2xl font-black tracking-tight text-gray-900 dark:text-white">Add Option</h1>
    ...
    <div class="bg-white dark:bg-slate-900 rounded-2xl border border-gray-200 dark:border-white/10 p-6 shadow-sm">
        <form method="POST"
              action="{{ route('admin.questions.options.store', $question->id) }}"
