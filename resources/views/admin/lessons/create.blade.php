...
@section('content')
    <div class="max-w-4xl mx-auto space-y-6" x-data="{
                ...
                addBlock(type = 'text') {
                    ...
                    if (type === 'file') this.blocks.push({ type: 'file' });
                    if (type === 'h5p') this.blocks.push({ type: 'h5p', h5p_embed: '' });
                },
                        ...
                        <div
                            ...
                            <div x-show="block.type === 'file'">
                                ...
                                <p class="text-xs text-gray-400 mt-1">
                                    pdf / docx / pptx / xlsx / images / zip / mp3 / mp4 / h5p if you allow it in backend
                                </p>
                            </div>
                            ...
                            <div x-show="block.type === 'h5p'">
                                ...
                                <textarea :name="`blocks[${i}][h5p_embed]`" rows="5" x-model="block.h5p_embed"
                                ...
                                <p class="text-xs text-gray-400 mt-1">
                                    Paste the full H5P iframe embed code here.
                                </p>
                            </div>
                        </div>
                    </template>
...
@section('scripts')
    ...
    <script>
        (function () {
            ...
            const initialHtml = @json(old('description', ''));
            if (initialHtml) {
