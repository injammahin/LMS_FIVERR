...
@section('content')
    @php
        ...
        $maxAttempts = (int) ($assignment->max_attempts ?? 0); // 0 = unlimited
    ...
    <div class="min-h-screen bg-gray-50">
        <div class="max-w-5xl mx-auto px-4 py-8 space-y-6">
            ...
            {{-- ✅ If submitted: show what student submitted --}}
            @if($isSubmitted)
                <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 space-y-4">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="text-xs text-gray-500">
                            Submitted at: <span
                                class="font-semibold">{{ optional($submission->submitted_at)->format('d M Y, h:i A') }}</span>
                        </div>
                    </div>
                    ...
                    @if(!empty($submission->submission_text))
                        <div class="rounded-xl border border-gray-200 bg-gray-50 p-4">
                            ...
                            <div class="prose max-w-none">{!! nl2br(e($submission->submission_text)) !!}</div>
                        </div>
                    @endif
                    ...
                    {{-- grading display (optional if admin graded) --}}
                        ...
                        <div class="rounded-xl border border-amber-200 bg-amber-50 p-4">
                            ...
                            @if($assignment->grading_type === 'points')
                                <div class="text-sm text-amber-800 mt-1">
                                    Marks: <span class="font-semibold">{{ $submission->marks_awarded }}</span>
