    ...
    <div class="min-h-screen bg-gray-50 dark:bg-slate-950">
        ...
        <div class="max-w-7xl mx-auto px-4 py-10 space-y-8">
            ...
            @if(!empty($unlockCelebration['show']))
                <section id="grandDivisionCelebration" class="relative overflow-hidden rounded-[36px] border border-yellow-200/70 bg-white shadow-[0_30px_80px_rgba(245,158,11,0.18)]">
                    <div class="absolute inset-0 bg-[radial-gradient(circle_at_15%_20%,rgba(250,204,21,0.26),transparent_28%),radial-gradient(circle_at_85%_15%,rgba(59,130,246,0.14),transparent_26%),radial-gradient(circle_at_50%_100%,rgba(16,185,129,0.10),transparent_30%)]"></div>
                    ...
                    <div class="absolute top-10 right-16 text-5xl celebration-float opacity-70" style="animation-delay:.4s;">🎉</div>
                    <div class="absolute bottom-10 left-20 text-4xl celebration-float opacity-60" style="animation-delay:.8s;">⭐</div>
                    <div class="absolute bottom-10 right-20 text-4xl celebration-float opacity-60" style="animation-delay:1.2s;">🚀</div>

                    <div class="relative px-6 py-8 md:px-10 md:py-10">
                        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8">

                            <div class="flex items-start gap-5">
                                <div class="h-20 w-20 md:h-24 md:w-24 rounded-[28px] bg-gradient-to-br from-yellow-300 via-amber-400 to-orange-500 text-white grid place-items-center shadow-[0_20px_50px_rgba(245,158,11,0.35)] celebration-icon">
                                    <i class="fa-solid fa-trophy text-4xl"></i>
                                </div>

                                <div class="space-y-3">
                                    <div class="inline-flex items-center gap-2 rounded-full bg-yellow-100 border border-yellow-200 px-4 py-2 text-xs md:text-sm font-bold text-yellow-800 tracking-[0.2em] uppercase">
                                        Division Unlocked
                                    </div>
                                    ...
                                    <div class="flex flex-wrap items-center gap-3 pt-1">
                                        <div class="rounded-2xl bg-blue-50 border border-blue-100 px-4 py-3">
                                            <div class="text-[11px] uppercase tracking-[0.2em] text-blue-600 font-semibold">Completed</div>
                                            <div class="text-lg md:text-xl font-extrabold text-gray-900 mt-1">
                                                {{ $unlockCelebration['from_division_name'] ?? 'Previous Division' }}
                                            </div>
                                        </div>

                                        <div class="rounded-2xl bg-emerald-50 border border-emerald-100 px-4 py-3 celebration-unlocked-chip">
                                            <div class="text-[11px] uppercase tracking-[0.2em] text-emerald-600 font-semibold">Unlocked</div>
                                            <div class="text-lg md:text-xl font-extrabold text-gray-900 mt-1">
                            ...
                            <div class="flex flex-col sm:flex-row lg:flex-col gap-3 shrink-0">
                                <a
                                    href="{{ !empty($unlockCelebration['to_division_id']) ? route('student.division.show', $unlockCelebration['to_division_id']) : route('student.dashboard') }}"
                                ...
                                <button
                                    type="button"
                                    id="dismissGrandDivisionCelebration"
                               ...
                               class="group relative block overflow-hidden rounded-3xl border border-gray-200 dark:border-white/10 bg-white dark:bg-slate-900 shadow-sm hover:shadow-xl transition-all duration-300 {{ $isNewlyUnlocked ? 'ring-4 ring-yellow-300/70 shadow-[0_0_0_6px_rgba(250,204,21,0.12)]' : '' }}">
                                ...
                                @if($isNewlyUnlocked)
                                    <div class="absolute top-4 right-4 z-20">
                                        <span class="inline-flex items-center gap-2 rounded-full bg-yellow-400 text-slate-900 px-4 py-2 text-xs font-extrabold shadow-lg celebration-pill">
                                            ✨ Newly Unlocked
                                        </span>
                                    </div>
                                @endif
                                ...
                                <div class="relative h-44 md:h-52">
                                    ...
                                    <div class="absolute top-4 left-4 flex gap-2 flex-wrap">
                                        ...
                                        @if($isNewlyUnlocked)
                                            <span class="px-3 py-1 rounded-full text-xs font-extrabold bg-yellow-400 text-slate-900 shadow-md">
                                                🎉 Unlocked Now
                                            </span>
                                        @endif
                                    </div>
