...
@section('content')
    ...
    <div class="space-y-6" x-data="{ view: 'grid' }">
        ...
        {{-- HERO --}}
        <div
            class="rounded-3xl overflow-hidden border border-gray-200 dark:border-white/10 bg-white dark:bg-slate-900 shadow-sm">
            <div class="relative">
                ...
                <div class="p-5 md:p-6 -mt-10">
                    <div class="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-4">
                        <div class="flex items-start gap-4">
                            <div
                                class="w-12 h-12 rounded-2xl bg-white/90 dark:bg-slate-950 border border-white/30 dark:border-white/10 shadow grid place-items-center text-indigo-700 dark:text-indigo-300">
                    ...
                    <div class="mt-5 grid grid-cols-1 lg:grid-cols-12 gap-3">
                        {{-- KPI --}}
                        <div
                            class="lg:col-span-4 rounded-2xl border border-gray-200 dark:border-white/10 bg-white dark:bg-slate-950 p-4 shadow-sm">
                            <div class="flex items-center justify-between">
                                ...
                                <div
                                    class="w-12 h-12 rounded-2xl bg-indigo-50 dark:bg-indigo-500/10 border border-indigo-100 dark:border-indigo-500/20 text-indigo-700 dark:text-indigo-200 grid place-items-center">
                        ...
                        {{-- Search --}}
                        <div
                            class="lg:col-span-8 rounded-2xl border border-gray-200 dark:border-white/10 bg-white dark:bg-slate-950 p-4 shadow-sm">
                            <div class="flex items-center gap-3">
                                <div
                                    class="w-11 h-11 rounded-2xl bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 text-gray-700 dark:text-white/80 grid place-items-center">
                                    <i class="fa-solid fa-magnifying-glass"></i>
                                </div>
                                <div class="flex-1 min-w-0">
                                    <label class="text-xs text-gray-500 dark:text-white/60">Search course / subject /
                                        division</label>
        ...
        {{-- COURSES --}}
        <div id="courseWrap" class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4"
            ...
            @forelse($courses as $course)
                ...
                <a href="{{ route('staff.courses.show', $course->id) }}"
                    ...
                    data-title="{{ strtolower($course->title) }}" data-subject="{{ strtolower($subjectName) }}"
                    data-division="{{ strtolower($divisionName) }}">

                    {{-- top gradient bar --}}
                    <div class="relative h-20 bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600">
                        <div class="absolute inset-0 opacity-20 bg-[radial-gradient(circle_at_30%_30%,white,transparent_45%)]">
                        </div>
                        <div class="absolute inset-0 opacity-15 bg-[radial-gradient(circle_at_70%_70%,white,transparent_45%)]">
                        </div>

                        <div class="absolute top-3 left-3">
                            <span
                                class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/15 border border-white/25 text-white text-xs">
                        ...
                        <div class="absolute top-3 right-3">
                            <span
                                class="w-10 h-10 rounded-2xl bg-white/15 border border-white/25 grid place-items-center text-white">
                    ...
                    <div class="p-5 space-y-4">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <span
                                class="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs border border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-white/5 text-gray-700 dark:text-white/80">
                                <i class="fa-solid fa-sitemap text-gray-400"></i>
                                {{ $divisionName }}
                            </span>

                            <span
                                class="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs border border-indigo-100 dark:border-indigo-500/20 bg-indigo-50 dark:bg-indigo-500/10 text-indigo-700 dark:text-indigo-200">
                                <i class="fa-solid fa-tag"></i>
                                {{ $subjectName }}
                            </span>

                            <span
                                class="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs border border-emerald-100 dark:border-emerald-500/20 bg-emerald-50 dark:bg-emerald-500/10 text-emerald-800 dark:text-emerald-200">
            ...
            @empty
                <div class="col-span-full">
                    <div
                        class="rounded-3xl border border-gray-200 dark:border-white/10 bg-white dark:bg-slate-900 p-10 text-center shadow-sm">
                        <div
                            class="mx-auto w-12 h-12 rounded-2xl bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 grid place-items-center text-gray-600 dark:text-white/70">
                            <i class="fa-solid fa-circle-info"></i>
                        </div>
                        <div class="mt-3 text-base font-semibold text-gray-900 dark:text-white">No courses assigned</div>
                        <div class="text-sm text-gray-500 dark:text-white/60 mt-1">Ask admin to assign courses to your staff
                            account.</div>
